...
//		dir.mkdir();//디렉토리 만들기
		...
		file1.createNewFile();//(해당 경로의)파일 만들기
		file2.createNewFile();//(해당 경로의)파일 만들기
		file3.createNewFile();//(해당 경로의)파일 만들기
		...
		for (int i = 0; i < contents.length; i++) {
			//1716170852455 : 1970년 1월 1일을 기준으로 오늘까지의 milisec(1/1000초)로 계산된 값(long type)
