...
//		Integer: Wrapper 클래스, parseInt : 문자열을 정수로 변환
		...
		System.out.println(Integer.toHexString(28));//1c=16+12(16진수 출력)
		System.out.println(Integer.toBinaryString(28));//11100=16+8+4=28(2진수 출력)
		System.out.println(Integer.bitCount(28));//11100 ->1이 3개(유효bit수 출력)
