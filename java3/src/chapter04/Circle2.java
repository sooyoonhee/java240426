...
//		매개변수와 멤버변수가 같을 때 :The assignment to variable radius has no effect
//		매개변수와 멤버변수가 같을 때 this 사용하면 경고창 없어짐
...
//		1. 객체 생성하면서 생성자 호출
		...
		/*
		Circle2 pizza=new Circle2();//반지름이 1이고, 이름(name)이 없는 피자 객체 생성
